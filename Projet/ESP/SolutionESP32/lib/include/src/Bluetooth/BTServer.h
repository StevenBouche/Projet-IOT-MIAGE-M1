...
typedef void (*OnMessageBluetooth)(String *message);
...
class BTServer : public BLEServerCallbacks, public BLECharacteristicCallbacks{
  ...
  private:
    ...
    OnMessageBluetooth onDataReceived;
  ...
  public:
    ...
    BTServer(){}
    void setup(OnMessageBluetooth onDataReceived);
...
void BTServer::setup(OnMessageBluetooth onDataReceived){
